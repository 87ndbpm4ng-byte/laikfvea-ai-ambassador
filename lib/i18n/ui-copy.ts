...
const en: UiCopy = {
  ...
  recognitionUnavailable: "Voice input isn’t available here. You can still type your question or use a Quick Question.",
  ...
  microphoneDenied: "Microphone access isn’t available. You can still type your question or use a Quick Question.",
  microphoneUnavailable: "A microphone isn’t available right now. Please try again, type your question or use a Quick Question.",
  recognitionTimeout: "I didn’t hear a question. Tap Talk and try again.",
  recognitionFailed: "I couldn’t hear that clearly. Please try again, type your question or use a Quick Question.",
...
const ru: UiCopy = {
  ...
  recognitionUnavailable: "Голосовой ввод сейчас недоступен. Вопрос можно напечатать или выбрать из быстрых вопросов.",
  ...
  microphoneDenied: "Доступ к микрофону недоступен. Вопрос можно напечатать или выбрать из быстрых вопросов.",
  microphoneUnavailable: "Микрофон сейчас недоступен. Попробуйте ещё раз, напечатайте вопрос или выберите быстрый вопрос.",
  recognitionTimeout: "Я не услышал вопрос. Нажмите «Говорить» и попробуйте ещё раз.",
  recognitionFailed: "Не удалось разобрать вопрос. Попробуйте ещё раз, напечатайте его или выберите быстрый вопрос.",
...
const zh: UiCopy = {
  ...
  playResponse: "播放回答",
  recognitionUnavailable: "目前无法使用语音输入。您仍可输入问题或选择快捷问题。",
  synthesisUnavailable: "此处暂不支持语音回答，回答会继续显示在屏幕上。",
  activationFailed: "语音可通过“开始说话”使用，您也可以输入问题。",
  escapeHint: "随时按 Esc 键即可停止语音。",
  microphoneDenied: "目前无法使用麦克风。您仍可输入问题或选择快捷问题。",
  microphoneUnavailable: "目前没有可用的麦克风。请重试、输入问题或选择快捷问题。",
  recognitionTimeout: "没有听到您的问题，请点击“开始说话”后再试一次。",
  recognitionFailed: "没有听清您的问题，请重试、直接输入问题或选择快捷问题。",
...
const yue: UiCopy = {
  ...
  playResponse: "播放答案",
  recognitionUnavailable: "而家暫時用唔到語音輸入。您仍然可以打字或者揀快速問題。",
  synthesisUnavailable: "暫時未能播放語音答案，答案會繼續顯示喺畫面上。",
  activationFailed: "您可以撳「講嘢」，或者喺下面打字提問。",
  escapeHint: "任何時候撳 Esc 都可以停止語音。",
  microphoneDenied: "而家暫時用唔到咪高峰。您仍然可以打字或者揀快速問題。",
  microphoneUnavailable: "而家冇可用嘅咪高峰。請再試、打字提問或者揀快速問題。",
  recognitionTimeout: "未聽到您的問題，請撳「講嘢」再試一次。",
  recognitionFailed: "未聽清楚您的問題，請再試、直接打字或者揀快速問題。",
...
const fr: UiCopy = {
  ...
  recognitionUnavailable: "La saisie vocale n’est pas disponible pour le moment. Vous pouvez écrire votre question ou choisir une question rapide.",
  ...
  microphoneDenied: "L’accès au microphone n’est pas disponible. Vous pouvez écrire votre question ou choisir une question rapide.",
  microphoneUnavailable: "Aucun microphone n’est disponible pour le moment. Réessayez, écrivez votre question ou choisissez une question rapide.",
  recognitionTimeout: "Je n’ai pas entendu de question. Appuyez sur « Parler » et réessayez.",
  recognitionFailed: "Je n’ai pas bien compris. Réessayez, écrivez votre question ou choisissez une question rapide.",
